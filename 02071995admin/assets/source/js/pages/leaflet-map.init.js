 ...
 */
 ...
 L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.YOUR_MAPBOX_TOKEN_HERE', {
     maxZoom: 18,
...
var osmUrl = 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',
     ...
     var osmUrl = 'https://api.mapbox.com/styles/v1/mapbox/light-v9/tiles/{z}/{x}/{y}?access_token=pk.YOUR_MAPBOX_TOKEN_HERE',
         osmAttrib = '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
         osm = L.tileLayer(osmUrl, {maxZoom: 18, attribution: osmAttrib});
